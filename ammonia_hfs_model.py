...
def NH3_model(
    velax, beam, invdata, hfsdata, dv_FWHM, v0, N, T, s, pf, Tbg=2.73 * u.K
):
    lpf = 0
    ref_nu0 = invdata["nu0 [GHz]"] * u.GHz
    velax_h = (
    ...
    nu0 = invdata["nu0 [GHz]"] * u.GHz
    A_ul = 10 ** invdata["logA [s^-1]"] / u.s
    g_u = invdata["g_u"]
    E_u = invdata["E_u [K]"] * u.K
